...
{
    public static string luaDir = Application.dataPath + "/LuaSupport/Lua";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/LuaSupport/ToLua/Lua";        //tolua lua文件目录
